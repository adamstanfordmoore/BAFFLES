...
def main():
    ...
    pp.close()
    """
    names = ['HIP 23418']#['HD 984','HD 206893','HR 2562']
    bv = [1.4]#[0.5,.44,.45]
    rhk = [np.log10(20)]#[-4.42,-4.466,-4.551]
    ...
    for i in range(len(names)):
        p = baf.get_posterior(bv[i],rhk[i],isUpperLim=True,maxAge=5000,pdfPage=pp,showPlot=True,title=" " ,logPlot=True)
        ...
        #my_plot.metal_vs_bv(bv_m,fits,METAL,pp,False)#,specific_clusters=[0,4,6,7])
    pp.close() 
