...
def main():
    ...
    baf.make_grids(bv_m,fits,medianSavefile=join(GRID_DIR,'median_rhk_'+date),\
                    setAsDefaults=True)    
    ...
    baf2.make_grids(bv_m,fits,upper_lim,join(GRID_DIR,'median_li_'+date),setAsDefaults=True)
